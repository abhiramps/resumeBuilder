                ...
                <div>
                    {content.experiences.map((exp, index) => (
                        <div
                            key={exp.id || index}
                            style={{
                                marginBottom: index < content.experiences.length - 1 ? '16px' : '0',
                                pageBreakInside: 'avoid',
                            }}
                        >
                            <div style={{
                ...
                <div>
                    {content.education.map((edu, index) => (
                        <div
                            key={edu.id || index}
                            style={{
                                marginBottom: index < content.education.length - 1 ? '12px' : '0',
                                pageBreakInside: 'avoid',
                            }}
                        >
                            <div style={{
                ...
                <div>
                    {Object.entries(skillsByCategory).map(([category, skillNames], index) => (
                        <div
                            key={category}
                            style={{
                                marginBottom: index < Object.keys(skillsByCategory).length - 1 ? '8px' : '0',
                            }}
                        >
                            <span style={{
                                fontWeight: 'bold',
                ...
                <div>
                    {content.certifications.map((cert, index) => (
                        <div
                            key={cert.id || index}
                            style={{
                                marginBottom: index < content.certifications.length - 1 ? '12px' : '0',
                                pageBreakInside: 'avoid',
                            }}
                        >
                            <div style={{
                ...
                <div>
                    {content.projects.map((project, index) => (
                        <div
                            ...
                            style={{
                                marginBottom: index < content.projects.length - 1 ? '16px' : '0',
                                pageBreakInside: 'avoid',
                            }}
                        >
                            <div style={{
