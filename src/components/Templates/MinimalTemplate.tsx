                ...
                <div>
                    {content.experiences.map((exp, index) => (
                        <div
                            key={exp.id || index}
                            style={{
                                marginBottom: index < content.experiences.length - 1 ? '10px' : '0',
                                pageBreakInside: 'avoid',
                            }}
                        >
                            <div style={{
                ...
                <div>
                    {Object.entries(skillsByCategory).map(([category, skillNames], index) => (
                        <div
                            key={category}
                            style={{
                                marginBottom: index < Object.keys(skillsByCategory).length - 1 ? '4px' : '0',
                            }}
                        >
                            <strong style={{
                                fontSize: `${layout.fontSize.body}pt`,
                ...
                <div>
                    {content.projects.map((project, index) => (
                        <div
                            ...
                            style={{
                                marginBottom: index < content.projects.length - 1 ? '10px' : '0',
                                pageBreakInside: 'avoid',
                            }}
                        >
                            <div style={{
