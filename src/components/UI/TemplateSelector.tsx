...
const TEMPLATE_INFO: Record<TemplateType, TemplateInfo> = {
    classic: {
        ...
        features: ['Times New Roman font', 'Centered header', 'Traditional bullets', 'Single column'],
    },
    modern: {
        id: 'modern',
        name: 'Modern',
        ...
        features: ['Sans-serif font', 'Accent colors', 'Grid skills layout', 'Contemporary style'],
    },
    minimal: {
        id: 'minimal',
        name: 'Minimal',
        ...
        features: ['Maximum density', 'Black & white', 'Minimal spacing', 'Space-optimized'],
    },
    abhiram: {
        id: 'abhiram',
        name: 'Abhiram',
        ...
        features: ['Centered header', 'Category skills', 'Professional colors', 'Single-page optimized'],
    },
};
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50">
                                <div className="text-sm text-gray-600">
                                    {selectedTemplate && selectedTemplate !== currentTemplate ? (
                                        <span>
                                            Switching to <strong>{TEMPLATE_INFO[selectedTemplate].name}</strong> template
                                        </span>
                                    ) : (
                                        <span>All resume data will be preserved when switching templates</span>
                                    )}
                                </div>
